...
public class KamusHelperIN {
    ...
    public KamusHelperIN(Context context) {
        this.context = context;
    }

    public KamusHelperIN open() throws SQLException {
    ...
    public ArrayList<KamusModel> getDataByName(String kata) {
            ...
            Cursor cursor = database.query(TABLE_KATA2, null, KATA + " LIKE ?", new String[]{kata}, null, null, _ID + " ASC", null);
            cursor.moveToFirst();
    ...
    public ArrayList<KamusModel> getAllData() {
            ...
            Cursor cursor = database.query(TABLE_KATA2, null, null, null, null, null, _ID + " ASC", null);
            cursor.moveToFirst();
            ArrayList<KamusModel> arrayList = new ArrayList<>();
            KamusModel kamusModel;
            if (cursor.getCount() > 0) {
